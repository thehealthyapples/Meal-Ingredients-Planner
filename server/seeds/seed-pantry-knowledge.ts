...
const ENTRIES: Array<{
  ...
  {
    ingredientKey: "extra virgin olive oil",
    supports: ["Healthy fats"],
    highlights: ["Rich in monounsaturated fats", "Source of natural polyphenols"],
  ...
  {
    ingredientKey: "fresh ginger",
    supports: ["Digestive comfort"],
    whyItMatters: "A warming root with a long culinary history, often used to support digestion and add depth.",
    tags: ["digestive", "anti-inflammatory", "spice"],
  },
  {
    ingredientKey: "ground ginger",
    supports: ["Digestive comfort"],
  ...
  {
    ingredientKey: "tinned chickpeas",
    supports: ["Fibre", "Plant protein"],
  ...
  {
    ingredientKey: "porridge oats",
    supports: ["Fibre", "Slow-release energy"],
    whyItMatters: "A whole grain that can support steadier energy levels and a varied breakfast.",
    tags: ["whole grain", "fibre", "energy"],
  },
  {
    ingredientKey: "brown rice",
  ...
  {
    ingredientKey: "apple cider vinegar",
...
export async function seedPantryKnowledge(): Promise<void> {
  await storage.seedStaticPantryKnowledge(ENTRIES);
  console.log(`[SeedPantryKnowledge] ${ENTRIES.length} entries seeded (skipped if already present)`);
}
