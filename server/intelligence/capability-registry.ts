...
const SEED_CAPABILITIES_BASE: readonly Capability[] = [
  {
    ...
    owningService: "server/lib/meal-service.ts, planner-compliance.ts",
  ...
  },
  {
    ...
    owningService: "server/lib/meal-service.ts, recipe-swap-engine.ts",
  ...
  },
  {
    ...
    owningService: "routes-resident diary logic",
