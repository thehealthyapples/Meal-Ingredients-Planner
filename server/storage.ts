...
export class DatabaseStorage implements IStorage {
  ...
  async deleteMealTemplate(id: number): Promise<void> {
    // RM3: the meal_template_products cascade was removed with that retired table.
