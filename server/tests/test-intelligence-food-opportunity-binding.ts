...
async function main(): Promise<void> {
  ...
  assert(live.length === 23, "exactly TWENTY-THREE live capabilities — FI4 extends food-intelligence (no new one); OD1 adds opportunity-delivery; EL1 separately adds evidence-learning", String(live.length));
  assert(
