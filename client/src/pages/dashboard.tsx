...
export default function Dashboard() {
  ...
  const plannedMealCount = userMeals.length;
    ...
    <div>
      ...
      >
        ...
        <div className="absolute left-0 right-0" style={{ marginTop: "var(--space-8)" }}>
          ...
          >
            <path
              d="M0 0C240 32 480 32 720 16C960 0 1200 0 1440 16V32H0V0Z"
            ...
            <Link href="/meals" aria-label="Go to My Meals">
              <Card className="h-full group cursor-pointer hover-elevate transition-all duration-200" data-testid="card-total-meals">
                <CardContent className="p-5">
                  ...
                  <div className="text-numeric" data-testid="text-meal-count">{userMeals.length}</div>
            ...
            <Link href="/analyse-basket" aria-label="Go to Basket">
              <Card className="h-full group cursor-pointer hover-elevate transition-all duration-200" data-testid="card-basket-items">
                <CardContent className="p-5">
                  ...
                  <div className="text-numeric">{shoppingListItems.length}</div>
            ...
            <Link href="/meals" aria-label="Go to Recipes">
              <Card className="h-full group cursor-pointer hover-elevate transition-all duration-200" data-testid="card-recipes">
                <CardContent className="p-5">
                  ...
                  <div className="text-numeric">{recipeMeals.length}</div>
            ...
            <Link href="/weekly-planner" aria-label="Go to Planner">
              <Card className="h-full group cursor-pointer hover-elevate transition-all duration-200" data-testid="card-planner">
                <CardContent className="p-5">
                  ...
                  <div className="text-numeric">{plannerWeeks.length || 6}</div>
              ...
              <Link href="/meals">
                <Card className="group cursor-pointer hover-elevate transition-all duration-200" data-testid="action-add-meal">
                  <CardContent className="p-5 flex items-center gap-4">
                    ...
                    <div>
                      <p className="title-card">Add Meal</p>
              ...
              <Link href="/weekly-planner">
                <Card className="group cursor-pointer hover-elevate transition-all duration-200" data-testid="action-view-planner">
                  <CardContent className="p-5 flex items-center gap-4">
                    ...
                    <div>
                      <p className="title-card">View Planner</p>
