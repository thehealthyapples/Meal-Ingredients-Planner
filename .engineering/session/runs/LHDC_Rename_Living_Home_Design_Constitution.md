...
## Key discipline
The historical report `docs/implementation/architecture/ED3_ENVIRONMENTAL_DRESSING_DESIGN_CONSTITUTION.md` is **NOT** renamed (its filename contains the substring) — path references were edited surgically, never blanket-replaced.
...
- [x] Wrote the task record `docs/implementation/architecture/LIVING_HOME_DESIGN_CONSTITUTION_RENAME.md`.
