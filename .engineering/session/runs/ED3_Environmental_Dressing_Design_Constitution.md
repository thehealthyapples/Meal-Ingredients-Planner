...
- [x] Write `docs/architecture/ENVIRONMENTAL_DRESSING_DESIGN_CONSTITUTION.md` (22 sections; the object-level visual admission standard; every value a citation; EXP3 Verdict 3 NOT resolved — quality standard only, medium routed to the Home Owner).
