...
- [x] Governing inputs read: docs/architecture/README.md (both pages), LIVING_HOME_EXPERIENCE_ARCHITECTURE.md (full), docs/implementation/house/EXP3_LIVING_HOME_ASSET_SYSTEM.md (full).
