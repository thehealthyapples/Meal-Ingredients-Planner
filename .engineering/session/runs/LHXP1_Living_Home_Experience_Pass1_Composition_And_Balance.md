...
| **Current stage** | Documentation → committing |
...
- [ ] Commit on `int1-intelligence-platform`; record commit hash here + dashboard.

**Last checkpoint:** verified baseline-clean; deliverable written; committing.
