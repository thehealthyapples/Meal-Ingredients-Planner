// LARDER Pass 1 — capture the empty Living Larder room (/larder) for the
// implementation report. Desktop (light + dark) and mobile. Full-page.
// Usage: npx tsx scripts/capture-larder-pass1.ts
...
async function main() {
  ...
  await shoot("LARDER_PASS1_desktop_light", { width: 1440, height: 900, scale: 2, dark: false });
  await shoot("LARDER_PASS1_desktop_dark",  { width: 1440, height: 900, scale: 2, dark: true });
  await shoot("LARDER_PASS1_mobile_light",  { width: 390, height: 844, scale: 3, dark: false });
