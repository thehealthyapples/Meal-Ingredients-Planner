...
**Source register:** `docs/investigations/THA_SOURCE_OF_TRUTH_ARCHITECTURE_REGISTER.md`
...
*Rollback: this document only — `git checkout HEAD docs/ARCHITECTURE_PRINCIPLES.md` (or delete the file to revert).*
