...
- [x] `docs/implementation/FI3_FOOD_INTELLIGENCE_ENGINE_FOUNDATION.md` (the exact Port→Handler→Binding this task extends; the precedent for exporting a previously-private function — `enrichEater` — for cross-module reuse, mirrored here for `resolveHouseholdSignal`)
...
- This implementation record exists at `docs/implementation/FI4_AMBIENT_FOOD_INTELLIGENCE_OPPORTUNITY_ENGINE.md` ✅
