...
> `docs/implementation/INT17_CONTEXT_COMPOSITION_ENGINE.md`, and verified and promoted in
> `docs/implementation/INT18_CONTEXT_COMPOSITION_ENGINE_IMPLEMENTATION.md`.
>
