...
**Judged against:** `GOVERNING_EXPERIENCE_ARCHITECTURE.md` (the Experience Constitution) and `docs/investigations/experience/EXPREVIEW1_FIRST_TIME_HOUSEHOLD_EXPERIENCE.md` § 6.
