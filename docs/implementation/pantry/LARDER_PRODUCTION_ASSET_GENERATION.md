...
**Report location:** `docs/implementation/pantry/LARDER_PRODUCTION_ASSET_GENERATION.md`
...
| `docs/implementation/pantry/LARDER_PRODUCTION_ASSET_GENERATION.md` | This report |
