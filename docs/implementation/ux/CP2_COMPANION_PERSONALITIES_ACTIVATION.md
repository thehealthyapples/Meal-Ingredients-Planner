...
docs/implementation/ux/CP2_COMPANION_PERSONALITIES_ACTIVATION.md (new)
```
...
- [x] `docs/implementation/intelligence/BEH1_BEHAVIOUR_ENGINE_ACTIVATION.md`
- [x] `docs/implementation/intelligence/EWO2_COMPANION_PERSONALITY_PLATFORM_IMPLEMENTATION.md`
- [x] `docs/implementation/intelligence/NCV1_NATIVE_CONTEXT_VIEW_ROLLOUT.md` (Native Context Views — reused, not extended)
