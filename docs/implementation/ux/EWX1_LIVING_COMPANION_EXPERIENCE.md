...
**Builds on:** the Intelligence Platform (TIP1–3, INT1–41) and the Companion Personality Platform ([EWO1](../../investigations/intelligence/EWO1_COMPANION_PLATFORM_FOUNDATION.md) design / [EWO2](../intelligence/EWO2_COMPANION_PERSONALITY_PLATFORM_IMPLEMENTATION.md) implementation)
**Risk:** 🟢 GREEN
...
- [x] [`EWO1_COMPANION_PLATFORM_FOUNDATION.md`](../../investigations/intelligence/EWO1_COMPANION_PLATFORM_FOUNDATION.md) — the personality-as-a-voice-layer architecture and its §5 hard invariant
- [x] [`EWO2_COMPANION_PERSONALITY_PLATFORM_IMPLEMENTATION.md`](../intelligence/EWO2_COMPANION_PERSONALITY_PLATFORM_IMPLEMENTATION.md) — the Behaviour Engine, Personality Registry, and Growth Model this task extends
- [x] [`FI4_AMBIENT_FOOD_INTELLIGENCE_OPPORTUNITY_ENGINE.md`](../intelligence/FI4_AMBIENT_FOOD_INTELLIGENCE_OPPORTUNITY_ENGINE.md) and [`FI5_FOOD_INTELLIGENCE_UI_ACTIVATION.md`](../intelligence/FI5_FOOD_INTELLIGENCE_UI_ACTIVATION.md) — the opportunity-delivery (OD1) bundle this task wraps as observations, never re-derives
...
| `docs/implementation/ux/EWX1_LIVING_COMPANION_EXPERIENCE.md` | This document |
