...
- [x] `docs/implementation/INT42_CAPABILITY_COMPOSITION_FOUNDATION.md` and `INT33_INTELLIGENCE_CAPABILITY_ORCHESTRATION_IMPLEMENTATION.md` (the composition precedents)
...
| `docs/implementation/INT50_FOOD_INTELLIGENCE_ACTIVATION.md` | **New** — this document |
...
- **INT50-only rollback commands** (preserves the unrelated, uncommitted KNOW4 work):
  ...
  rm docs/implementation/INT50_FOOD_INTELLIGENCE_ACTIVATION.md
