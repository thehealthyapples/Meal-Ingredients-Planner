...
- **Files added:** `server/intelligence/{types,capability-registry,permissions,intent-engine,intelligence-platform,index}.ts`, `server/intelligence/README.md`, `server/tests/test-intelligence-platform.ts`, `docs/implementation/INT1_INTELLIGENCE_PLATFORM_FOUNDATION_IMPLEMENTATION.md`
