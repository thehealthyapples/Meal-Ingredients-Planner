...
- [x] `docs/implementation/INT35B_COMPANION_LEARNING_AND_OBSERVABILITY.md`
...
| `docs/implementation/INT35C_GOVERNED_COMPANION_LEARNING_AND_DASHBOARD.md` | **NEW** — this document |
