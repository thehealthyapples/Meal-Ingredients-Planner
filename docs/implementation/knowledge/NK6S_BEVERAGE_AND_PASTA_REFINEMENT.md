...
**Predecessors:** [`NK6R`](./NK6R_CANONICAL_FOOD_IDENTITY_IMPLEMENTATION.md) (the `family` column) · [`NK6Q`](../../investigations/knowledge/NK6Q_CANONICAL_FOOD_IDENTITY_GOVERNANCE.md) · [`NK6M`](./NK6M_CANONICAL_NUTRIENT_MODEL_REFINEMENT.md)
