...
- [x] `docs/implementation/knowledge/KNOW1_FOOD_INTELLIGENCE_EXPANSION.md`, `KNOW2_KNOWLEDGE_FOOD_OWNERSHIP_CONVERGENCE.md`
...
docs/implementation/knowledge/KNOW3_CANONICAL_KNOWLEDGE_FOOD_BINDING.md (new)
```
