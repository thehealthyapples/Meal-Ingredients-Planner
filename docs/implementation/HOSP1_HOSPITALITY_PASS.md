...
- **Files modified:** 22 household-facing `client/src` files (§ 3 table) · `docs/implementation/HOSP1_HOSPITALITY_PASS.md` (this report) · `.engineering/session/CURRENT.md` (dashboard row) · `.engineering/session/runs/HOSP1_Hospitality_Pass_1.md` (session record).
- **Rollback command:**
  ```
