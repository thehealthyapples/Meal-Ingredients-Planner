...
`docs/implementation/BENCH2_INTELLIGENCE_BENCHMARK_HARDENING.md` (the immediate predecessor).
...
rm -f server/tests/benchmark/capability-probe.ts \
      ...
      docs/implementation/BENCH2C_CAPABILITY_UTILISATION_DASHBOARD.md
```
