...
**EWO:** EWO2 (implements the design approved in [EWO1](../investigations/EWO1_COMPANION_PLATFORM_FOUNDATION.md))
**Risk:** 🟡 AMBER
...
- [x] [`EWO1_COMPANION_PLATFORM_FOUNDATION.md`](../investigations/EWO1_COMPANION_PLATFORM_FOUNDATION.md) — the approved architecture this task implements verbatim (Personality as a voice layer, not a second assistant; §5 hard invariant; Phase P0–P3 roadmap)
...
| `docs/implementation/EWO2_COMPANION_PERSONALITY_PLATFORM_IMPLEMENTATION.md` | This document |
