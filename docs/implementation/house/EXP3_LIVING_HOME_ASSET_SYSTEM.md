...
- **Files modified:** `docs/implementation/house/EXP3_LIVING_HOME_ASSET_SYSTEM.md` (new) · `.engineering/session/CURRENT.md` (session row) · `.engineering/session/runs/EXP3_Living_Home_Asset_System.md` (session record).
- **Rollback commands:**
  ```
  git checkout rollback/EXP3-living-home-asset-system-20260720 -- .engineering/session/CURRENT.md
  git rm docs/implementation/house/EXP3_LIVING_HOME_ASSET_SYSTEM.md
