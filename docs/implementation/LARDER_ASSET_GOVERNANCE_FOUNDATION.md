...
**Report location:** `docs/implementation/LARDER_ASSET_GOVERNANCE_FOUNDATION.md`
...
- `docs/implementation/EXP3_LIVING_HOME_ASSET_SYSTEM.md` (via register/verifier headers — the two-register model and § 4.4 checksum law)
...
| `docs/implementation/LARDER_ASSET_GOVERNANCE_FOUNDATION.md` | This report |
