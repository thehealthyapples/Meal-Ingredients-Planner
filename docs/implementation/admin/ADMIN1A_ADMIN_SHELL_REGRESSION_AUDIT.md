...
2. `docs/implementation/admin/ADMIN1_ADMIN_DOMAIN_SHELL_IMPLEMENTATION.md` (5.0 KB)
   - Documentation only
   - **Impact scope:** None
...
git rm docs/implementation/admin/ADMIN1_ADMIN_DOMAIN_SHELL_IMPLEMENTATION.md
