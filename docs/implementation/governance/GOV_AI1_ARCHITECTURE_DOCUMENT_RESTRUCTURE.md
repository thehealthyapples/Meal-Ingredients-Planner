...
| THA Source of Truth Register | `docs/investigations/governance/THA_SOURCE_OF_TRUTH_ARCHITECTURE_REGISTER.md` | `docs/architecture/THA_SOURCE_OF_TRUTH_ARCHITECTURE_REGISTER.md` |
| THA Engineering Workflow | `docs/ENGINEERING_WORKFLOW.md` | `docs/architecture/ENGINEERING_WORKFLOW.md` |
| THA Master Evolution Roadmap | `docs/investigations/governance/THA_LAUNCH_ROADMAP.md` | `docs/architecture/THA_MASTER_EVOLUTION_ROADMAP.md` (renamed to canonical governance name) |

Established filenames (`ARCHITECTURE_PRINCIPLES.md`, `ENGINEERING_WORKFLOW.md`) were preserved deliberately: renaming `ARCHITECTURE_PRINCIPLES.md` to `THA_CORE_ARCHITECTURE_PRINCIPLES.md` would collide with the basename of the unrelated source investigation `docs/investigations/governance/THA_CORE_ARCHITECTURE_PRINCIPLES.md` and create a duplicate-ownership ambiguity. The roadmap carried a non-canonical name (`THA_LAUNCH_ROADMAP.md`) and was renamed to its governance identity `THA_MASTER_EVOLUTION_ROADMAP.md`.

### 3. Intelligence Governance documents promoted and renamed

| From (investigation) | To (governing) |
|---|---|
| `docs/investigations/intelligence/TIP1_INTELLIGENCE_PLATFORM_ARCHITECTURE_INVESTIGATION.md` | `docs/architecture/THA_INTELLIGENCE_PLATFORM_ARCHITECTURE.md` |
| `docs/investigations/intelligence/TIP2_AI_CAPABILITY_REGISTRY_AND_INTENT_TAXONOMY.md` | `docs/architecture/THA_AI_CAPABILITY_REGISTRY_AND_INTENT_TAXONOMY.md` |
| `docs/investigations/intelligence/TIP3_AI_EXPERIENCE_AND_CONVERSATION_ARCHITECTURE.md` | `docs/architecture/THA_AI_EXPERIENCE_AND_CONVERSATION_ARCHITECTURE.md` |
...
- `docs/investigations/governance/THA_SOURCE_OF_TRUTH_ARCHITECTURE_REGISTER.md`, `docs/investigations/governance/THA_LAUNCH_ROADMAP.md`
...
- **Core Architecture Principles vs investigation:** the governing principles document (`ARCHITECTURE_PRINCIPLES.md`) was moved. The separate source investigation `docs/investigations/governance/THA_CORE_ARCHITECTURE_PRINCIPLES.md` is genuine history and was left untouched (it is not governing architecture).
