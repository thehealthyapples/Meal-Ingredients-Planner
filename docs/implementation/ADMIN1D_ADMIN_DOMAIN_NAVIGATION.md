...
**Related:** [`AUDIT1_PLATFORM_REGRESSION_AND_FEATURE_AVAILABILITY.md`](../investigations/AUDIT1_PLATFORM_REGRESSION_AND_FEATURE_AVAILABILITY.md) §F3 (no in-app return path from admin pages); [`ADMIN1B_ADMIN_DOMAIN_ENTRY_POINT.md`](./ADMIN1B_ADMIN_DOMAIN_ENTRY_POINT.md) (registered the routes this builds on)
