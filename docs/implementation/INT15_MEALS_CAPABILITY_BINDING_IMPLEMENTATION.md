...
| `docs/implementation/INT15_MEALS_CAPABILITY_BINDING_IMPLEMENTATION.md` | This report |
...
- [x] Implementation report saved at `docs/implementation/INT15_MEALS_CAPABILITY_BINDING_IMPLEMENTATION.md`
