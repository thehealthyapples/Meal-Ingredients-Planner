...
git checkout cp1-rollback-1783190596 -- \
  ...
  docs/implementation/ux/CP1_COMPANION_PRESENCE_FOUNDATION.md
```
...
- `docs/investigations/intelligence/COMPANION_ROLLOUT_SEQUENCE.md` (phased activation of Companion capabilities across the platform)
