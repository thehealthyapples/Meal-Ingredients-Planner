...
| Rollback command | `git rm docs/implementation/FOUNDATION_MEALS2_THA500_EDITORIAL_REVIEW.md` — or `git checkout rollback/FOUNDATION_MEALS2-pre` |
