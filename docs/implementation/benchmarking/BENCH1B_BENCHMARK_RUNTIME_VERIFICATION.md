...
**Related:** [`BENCH1_BENCHMARK_HOUSEHOLDS_JSON_REGRESSION.md`](./BENCH1_BENCHMARK_HOUSEHOLDS_JSON_REGRESSION.md) (registered the missing routes), [`AUDIT1_PLATFORM_REGRESSION_AND_FEATURE_AVAILABILITY.md`](../../investigations/platform/AUDIT1_PLATFORM_REGRESSION_AND_FEATURE_AVAILABILITY.md)
