...
- [x] `docs/implementation/benchmarking/BM4B_BENCHMARK_HUMAN_REVIEW_LAYER.md` (prior report enhancement — direct predecessor of this work)
...
- "Related Investigation(s)" and "Related Implementation(s)" are free-text so they can reference existing docs (e.g. `docs/investigations/benchmarking/BM1_BENCHMARK_68_ROOT_CAUSE.md`, `docs/implementation/BM2_...md`) without the report generator needing to know about the documentation corpus
