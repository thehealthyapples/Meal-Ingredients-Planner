...
`docs/investigations/intelligence/INTA1_INTELLIGENCE_PLATFORM_WIRING_AUDIT.md` (the audit this workstream discharges),
...
rm -f server/tests/test-benchmark-routing-integrity.ts \
      docs/implementation/benchmarking/BENCH2_INTELLIGENCE_BENCHMARK_HARDENING.md
```
...
`docs/implementation/benchmarking/BENCH2_BENCHMARK_ARTIFACT_DOWNLOAD_BEHAVIOUR.md` already exists (untracked) and also claims the
