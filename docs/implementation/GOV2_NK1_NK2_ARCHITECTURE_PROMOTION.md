...
**Location before:** `docs/investigations/NK1_CANONICAL_NUTRITION_KNOWLEDGE_PLATFORM.md`  
...
**Location before:** `docs/investigations/NK2_THA_NUTRITION_METHODOLOGY.md`  
...
- `docs/investigations/NK1_CANONICAL_NUTRITION_KNOWLEDGE_PLATFORM.md` (kept as link stability)
- `docs/investigations/NK2_THA_NUTRITION_METHODOLOGY.md` (kept as link stability)
...
| Implementation report created | ✅ | docs/implementation/GOV2_NK1_NK2_ARCHITECTURE_PROMOTION.md |
