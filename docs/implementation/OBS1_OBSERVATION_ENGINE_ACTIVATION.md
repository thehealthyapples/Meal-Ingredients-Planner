...
| Governing docs updated: CPA1, INT21 Behaviour Engine, Platform Quality, README; INT20's record carries a re-scope banner and is otherwise preserved as history | `docs/architecture/*`, `docs/implementation/INT20_OBSERVATION_ENGINE_ARCHITECTURE.md`, `docs/implementation/INT21_BEHAVIOUR_ENGINE_ARCHITECTURE.md` |
