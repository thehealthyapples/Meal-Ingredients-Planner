...
| This task's writes | `docs/implementation/ADMIN1C_ADMIN_DOMAIN_RESTORATION.md` (this document) only |
...
- [x] `docs/investigations/AUDIT1_PLATFORM_REGRESSION_AND_FEATURE_AVAILABILITY.md` (the audit that identified — and confirmed the resolution of — the Admin orphaning, Finding F1)
- [x] `docs/implementation/ADMIN1B_ADMIN_DOMAIN_ENTRY_POINT.md` (the implementation that restored the Admin entry point)
...
- **Files modified by ADMIN1C:** `docs/implementation/ADMIN1C_ADMIN_DOMAIN_RESTORATION.md` only.
- **Rollback commands:** `git rm docs/implementation/ADMIN1C_ADMIN_DOMAIN_RESTORATION.md` (or `git checkout rollback/before-admin1c-20260707`).
