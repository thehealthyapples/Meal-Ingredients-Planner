...
**EWO:** EWO-INT41 (🟡 AMBER)
**Builds on:** [`INT39_CAPABILITY_GUIDANCE_REGISTRY_AND_GOAL_COMPLETION.md`](./INT39_CAPABILITY_GUIDANCE_REGISTRY_AND_GOAL_COMPLETION.md) · [`INT37_COMPANION_CARD_EXPERIENCE_IMPLEMENTATION.md`](../ux/INT37_COMPANION_CARD_EXPERIENCE_IMPLEMENTATION.md) · [`THA_AI_CAPABILITY_REGISTRY_AND_INTENT_TAXONOMY.md`](../../architecture/THA_AI_CAPABILITY_REGISTRY_AND_INTENT_TAXONOMY.md)
