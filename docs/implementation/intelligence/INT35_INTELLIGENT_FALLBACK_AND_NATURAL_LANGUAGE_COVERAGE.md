...
**Status:** 🟢 IMPLEMENTED
**Date:** 2026-07-02
**Precursor:** [`docs/investigations/intelligence/INT34_CONVERSATION_GATEWAY_CAPABILITY_ROUTING_AUDIT.md`](../../investigations/intelligence/INT34_CONVERSATION_GATEWAY_CAPABILITY_ROUTING_AUDIT.md) (🔴 RED — two of four live queries failed at the resolver and collapsed into the generic "I don't have that information right now")
