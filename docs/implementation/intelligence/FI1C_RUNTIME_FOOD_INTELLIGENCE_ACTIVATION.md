...
**Governing architecture:** `docs/architecture/THA_FOOD_INTELLIGENCE_PLATFORM_ARCHITECTURE.md` (Food Intelligence is the single owner/enricher; Companion is a consumer, never a second owner — §2, §3, §7.1); `docs/investigations/benchmarking/FI1B0_BENCHMARK_ROUTING_VERIFICATION.md` (the routing gap this task closes).
