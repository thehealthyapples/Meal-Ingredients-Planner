...
- [x] `docs/implementation/intelligence/FI5_HOUSEHOLD_NUTRITION_INTELLIGENCE_IMPLEMENTATION.md` (confirmed FI5's own Scope Lock explicitly named "current-week-only variety" as future work — this task is that future work, using the canonical WS2A mechanism FI5 itself did not touch)
