...
- [x] `docs/implementation/intelligence/OD1_OPPORTUNITY_DELIVERY_FRAMEWORK.md` (the delivery lifecycle, `OPPORTUNITY_SOURCES`, `opportunity_deliveries` ownership, honest exclusions the rollout inherits)
...
| `docs/implementation/intelligence/INT20_OBSERVATION_ENGINE_ARCHITECTURE.md` | **New** — this record |
