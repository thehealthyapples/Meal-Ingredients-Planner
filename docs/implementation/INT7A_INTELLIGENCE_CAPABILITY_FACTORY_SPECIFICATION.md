...
| New files | `docs/architecture/INTELLIGENCE_CAPABILITY_FACTORY.md` (factory), `docs/implementation/INT7A_INTELLIGENCE_CAPABILITY_FACTORY_SPECIFICATION.md` (this report) |
...
| `docs/implementation/INT7A_INTELLIGENCE_CAPABILITY_FACTORY_SPECIFICATION.md` | This implementation report |
