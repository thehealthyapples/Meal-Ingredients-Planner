...
11. **Good enough is never a reason to stop improving.** The Home Owner's care for the home is continual. Beauty, hospitality and calm are not states a release reaches and then holds — they are living qualities, refined a little further each time the house is returned to. **Completion is a release milestone; refinement is continuous.** This establishes The Healthy Apples as a *lived home rather than a finished product*. The principle is not licence to disturb a settled room for novelty's sake — Principle 9 (emotional consistency over novelty) and the restraint laws (**GEA11 · GEA13 · GEA15**, cited) bind every refinement exactly as before, and a change that does not strengthen the feeling of home is noise, not care (Principle 6). It is the opposite: the standing refusal to let *"good enough"* become the reason a household's home stops being cared for. It names, as a permanent duty rather than a one-time cleanup, what `PX1` found in the platform's own words — that THA's experience defects are *"defects of adoption, not of knowledge"* (cited): the rules can be complete while the home is still not as welcoming as it could be, and closing that distance is the Home Owner's continuing work. It is the Home Owner's face of the Living Home's founding distinction (`LIVINGHOME1`, cited) — *the house holds still; the life moves* — for the care that keeps the still house worth returning to never finishes. Premium is *"the perceptible result of care taken on the household's behalf"* (`THA_EXPERIENCE_ARCHITECTURE.md` § 17, cited); care that has stopped is care the household would feel the absence of.

*Added under `UINORTH1` (2026-07-20), opening the North Star UI implementation programme, on the owner's brief that the home is continually cared for. Governance only; it moves no rule, and the restraint and consistency laws it cites are unchanged.*
