...
**Related:** [`NK6H_CANONICAL_FOOD_IMPORT_COMPLETION.md`](../implementation/NK6H_CANONICAL_FOOD_IMPORT_COMPLETION.md), `shared/knowledge/canonical-vocabulary-resolver.ts`, `server/lib/canonical-foods-importer.ts`, `shared/schema.ts`
