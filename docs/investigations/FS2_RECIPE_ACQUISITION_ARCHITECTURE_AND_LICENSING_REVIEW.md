...
| Undo this doc only | `rm docs/investigations/FS2_RECIPE_ACQUISITION_ARCHITECTURE_AND_LICENSING_REVIEW.md && git tag -d rollback/before-fs2-recipe-acquisition-20260702` |
...
- Files added: `docs/investigations/FS2_RECIPE_ACQUISITION_ARCHITECTURE_AND_LICENSING_REVIEW.md` only.
- Rollback command: `rm docs/investigations/FS2_RECIPE_ACQUISITION_ARCHITECTURE_AND_LICENSING_REVIEW.md && git tag -d rollback/before-fs2-recipe-acquisition-20260702`.
