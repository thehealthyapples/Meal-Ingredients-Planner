...
**Governing docs read first:** `docs/architecture/README.md` bootstrap → **GOV2 Canonical Alias Principle** → `docs/investigations/NK6J_CANONICAL_FOOD_BATCH_001_002_IMPORT_PLAN.md` (predecessor method).
