...
- `docs/investigations/ux/FAMILY_CONFIDENCE_LEARNING_COPY_UPDATE.md`
- `docs/investigations/cookbook/MEAL_DETAIL_FAMILY_CONFIDENCE_TRUST_FIX.md`
- `docs/investigations/knowledge/PANTRY_V2_NUTRITION_KNOWLEDGE_HUB.md`
- `docs/investigations/knowledge/THA_30_PLANTS_MODAL_V2.md`
- `docs/investigations/knowledge/THA_30_PLANTS_MODAL_V2_DESIGN_VALIDATION.md`
- `docs/investigations/knowledge/THA_30_PLANTS_MODAL_V2_FEASIBILITY_REVIEW.md`
- `docs/investigations/knowledge/THA_30_PLANTS_MODAL_V2_HEALTH_BENEFITS_AMENDMENT.md`
- `docs/investigations/knowledge/THA_30_PLANTS_MODAL_V2_SUPPORT_MODEL_AMENDMENT.md`
- `docs/investigations/knowledge/THA_30_PLANTS_PAGE_FINAL_DESIGN.md`
- `docs/investigations/knowledge/THA_HEALTH_BENEFITS_CONNECTED_EXPERIENCE_IMPLEMENTATION.md`
- `docs/investigations/knowledge/WEEKLY_NUTRITION_REPORT_AND_CAUTION_FOODS_MODEL.md`
