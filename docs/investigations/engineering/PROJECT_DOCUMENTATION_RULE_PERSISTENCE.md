...
| This task's writes | `docs/ENGINEERING_WORKFLOW.md`, `docs/investigations/engineering/PROJECT_DOCUMENTATION_RULE_PERSISTENCE.md` |
...
| `docs/investigations/engineering/PROJECT_DOCUMENTATION_RULE_PERSISTENCE.md` | Created | This investigation document |
...
**No application code changed:** git diff is limited to `docs/ENGINEERING_WORKFLOW.md` (documentation) and the new `docs/investigations/engineering/PROJECT_DOCUMENTATION_RULE_PERSISTENCE.md`.
...
| Rollback command | `git checkout rollback/before-project-documentation-rule-20260629 -- docs/ENGINEERING_WORKFLOW.md && rm docs/investigations/engineering/PROJECT_DOCUMENTATION_RULE_PERSISTENCE.md` |
