...
rm docs/investigations/knowledge/M3_CANONICAL_DIETARY_RULES_CONVERGENCE_IMPLEMENTATION.md
```
...
*Rollback tag: `m3-dietary-rules-pre-convergence` → `a8a912a`*
*Project file: `docs/investigations/knowledge/M3_CANONICAL_DIETARY_RULES_CONVERGENCE_IMPLEMENTATION.md`*
