...
**Predecessor:** `docs/investigations/knowledge/NK6I_CANONICAL_FOOD_IDENTITY_RESOLUTION_AUDIT.md` (fixed the importer to reconcile identity through the one resolver before minting).
...
`docs/investigations/knowledge/NK6J_CANONICAL_FOOD_BATCH_001_002_IMPORT_PLAN.md` (this file).
