...
`docs/investigations/knowledge/WS0X_FOOD_INTELLIGENCE_EXPANSION_PROGRAM.md` — present, unmodified.
...
*Report location: `docs/investigations/knowledge/WS0X_1_FIRST_500_FOODS_PROMOTION_PREVIEW.md`*
