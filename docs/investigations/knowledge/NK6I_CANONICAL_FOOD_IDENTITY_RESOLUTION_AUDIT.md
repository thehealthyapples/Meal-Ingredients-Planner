...
`docs/investigations/knowledge/NK6I_CANONICAL_FOOD_IDENTITY_RESOLUTION_AUDIT.md` (this file).

**Related:** `docs/investigations/knowledge/BATCH_001_CANONICAL_FOOD_IMPORT_VALIDATION.md` (prior read-only validation that first surfaced the identity-axis risk), `docs/architecture/GOV2_CANONICAL_ALIAS_PRINCIPLE.md` (governing principle).
