...
- **Rollback procedure:** This investigation writes exactly ONE new file (this document). To roll back: `git rm docs/investigations/knowledge/WS0X_3_FOOD_CONTEXT_TAGGING_ARCHITECTURE.md`. No existing uncommitted work is touched.
