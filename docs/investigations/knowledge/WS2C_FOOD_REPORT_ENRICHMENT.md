...
| **Undo this doc only** | `rm docs/investigations/knowledge/WS2C_FOOD_REPORT_ENRICHMENT.md` |
...
**File location:** `docs/investigations/knowledge/WS2C_FOOD_REPORT_ENRICHMENT.md`
