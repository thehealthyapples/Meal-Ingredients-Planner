...
| **Undo this doc only** | `rm docs/investigations/knowledge/WS2D_CANONICAL_NUTRITION_KNOWLEDGE_ARCHITECTURE.md` |
...
**File location:** `docs/investigations/knowledge/WS2D_CANONICAL_NUTRITION_KNOWLEDGE_ARCHITECTURE.md`
