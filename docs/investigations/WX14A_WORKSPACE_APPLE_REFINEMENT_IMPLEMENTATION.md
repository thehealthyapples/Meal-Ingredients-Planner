...
### Documentation
- `docs/investigations/WX14_PLATFORM_NAVIGATION_OWNERSHIP_AND_GLOBAL_HEADER_IMPLEMENTATION.md` — appended the corrected, canonical platform rule (Workspace Apple is optional) and a superseding note for the Pantry/Nutrition entries.
- This report.
