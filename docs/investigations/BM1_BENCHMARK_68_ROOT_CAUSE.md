...
- `docs/implementation/FI2_FOOD_BENEFIT_RELATIONSHIP_EXPANSION_IMPLEMENTATION.md` (opportunity discovery, but evidence chain composition incomplete)
- `docs/implementation/FI3_COMPANION_FOOD_ANSWER_COMPOSITION_IMPLEMENTATION.md` (answers composed, but pre-fetched evidence layer still missing)
...
- `docs/implementation/INT13_HOUSEHOLD_CAPABILITY_BINDING_IMPLEMENTATION.md` (household-awareness is registered, but enrichment layer incomplete)
...
- `docs/implementation/PKC1_CANONICAL_KNOWLEDGE_CONVERGENCE_IMPLEMENTATION.md` (Knowledge Registry convergence, but SourceRef layer not yet fully composed into capability handlers)
...
**Related Documents:**
- `docs/implementation/INT17_ANALYSER_CAPABILITY_BINDING_IMPLEMENTATION.md` (Analyser binding exists, but enrichment layer incomplete)
