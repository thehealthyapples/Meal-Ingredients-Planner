...
| `docs/investigations/FI2_FUTURE_STATE_FOOD_INTELLIGENCE_EXPERIENCE.md` | Experience vision (not code) |
| `docs/implementation/FI3_FOOD_INTELLIGENCE_ENGINE_FOUNDATION.md` | FI3 implementation record |
| `docs/implementation/FI4_AMBIENT_FOOD_INTELLIGENCE_OPPORTUNITY_ENGINE.md` | FI4 implementation record |
| `docs/implementation/EL1_EVIDENCE_AND_LEARNING_PLATFORM.md` | Evidence & Learning Platform |
