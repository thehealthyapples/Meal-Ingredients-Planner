...
Untracked (not staged, not committed):
  ...
  docs/investigations/COMPONENT_MEAL_ADAPTABILITY_RANKING.md
  docs/investigations/COMPONENT_MEAL_CATALOGUE_RANKING.md
  docs/investigations/COMPONENT_MEAL_RECOVERY_FEASIBILITY.md
  docs/investigations/COOKED_BREAKFAST_MEAL_SHELL_SEED.md
  docs/investigations/HOUSEHOLD_EATERS_INTEGRATION_AUDIT.md
  docs/investigations/KETO_LOW_CARB_DIETARY_DICTIONARY_IMPLEMENTATION.md
  docs/investigations/LIVE_HOUSEHOLD_COMPONENT_MEAL_VALIDATION.md
  docs/investigations/MATCH_MEALS_HOUSEHOLD_EATERS_IMPLEMENTATION.md
  docs/investigations/MATCH_MEALS_HOUSEHOLD_EATERS_MIGRATION_SCOPE.md
  docs/investigations/MEAL_TEMPLATE_ARCHITECTURE_AUDIT.md
  docs/investigations/MEAL_TEMPLATE_SLOT_WRITE_PATH_INVESTIGATION.md
  docs/investigations/PLANNER_GENERATION_PATH_ROOT_CAUSE.md
  docs/investigations/PLANNER_VISIBLE_WEEK_EXECUTION_TRACE.md
  docs/investigations/SMART_PLANNER_CANDIDATE_POOL_TRACE.md
  docs/investigations/SMART_PLANNER_DISCOVERY_STRATEGY_AUDIT.md
  docs/investigations/SMART_PLANNER_EXTERNAL_BACKFILL_FEASIBILITY.md
  docs/investigations/SMART_PLANNER_POST_RESTART_VALIDATION.md
...
| Catalogue ranking documents | `docs/investigations/COMPONENT_MEAL_CATALOGUE_RANKING.md` | Untracked investigation output |
| Adaptability ranking documents | `docs/investigations/COMPONENT_MEAL_ADAPTABILITY_RANKING.md` | Untracked investigation output |
