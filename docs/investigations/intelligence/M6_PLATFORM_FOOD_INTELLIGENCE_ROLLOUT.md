...
- [x] `docs/investigations/knowledge/M4_5_FERMENTED_FOOD_ATTRIBUTE_IMPLEMENTATION.md`
- [x] `docs/investigations/intelligence/M5_TRUSTED_FOOD_INTELLIGENCE_ACTIVATION.md`
- [x] `docs/investigations/intelligence/THA_FOOD_INTELLIGENCE_SURFACE_AUDIT.md`
...
| Files modified | `docs/investigations/intelligence/M6_PLATFORM_FOOD_INTELLIGENCE_ROLLOUT.md` only |
| Rollback command | `git checkout rollback/before-m6-platform-food-intelligence-20260625 -- docs/investigations/intelligence/M6_PLATFORM_FOOD_INTELLIGENCE_ROLLOUT.md` |

### After rollback, verify

```bash
# Confirm project file removed
ls docs/investigations/intelligence/M6_PLATFORM_FOOD_INTELLIGENCE_ROLLOUT.md
