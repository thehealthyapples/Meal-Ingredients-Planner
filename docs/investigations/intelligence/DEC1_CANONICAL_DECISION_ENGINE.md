...
| Rollback | `git rm docs/investigations/intelligence/DEC1_CANONICAL_DECISION_ENGINE.md` (no other artifact exists) |
...
- [x] `docs/implementation/intelligence/ATTN1_ATTENTION_PLATFORM.md` + `docs/investigations/intelligence/ATTN1_ATTENTION_PRIORITY_MODEL.md` (via the implementation record)
- [x] `docs/implementation/intelligence/OD1_OPPORTUNITY_DELIVERY_FRAMEWORK.md`
- [x] `docs/implementation/planner/PLAN1_PLANNER_INTELLIGENCE.md`, `COACH1_PROACTIVE_COACHING.md`, `COMP1_FOOD_COMPARISON_INTELLIGENCE.md`, `COMP2_NATURAL_CONVERSATION.md`, `LEARN1_HOUSEHOLD_LEARNING.md`
