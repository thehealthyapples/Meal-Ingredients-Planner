...
**Supersedes / extends:** `docs/investigations/WEEKLY_NUTRITION_REPORT_AND_CAUTION_FOODS_MODEL.md`
...
| **Undo this doc only** | `rm docs/investigations/WEEKLY_NUTRITION_REPORT_FINAL_ARCHITECTURE.md` |
