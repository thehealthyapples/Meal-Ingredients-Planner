...
| `docs/investigations/COMPONENT_CLASSIFICATION_SMART_PLANNER_FIX.md` | 11 classified component meals |
| `docs/investigations/SMART_PLANNER_SLOT_FILLING_RECOVERY.md` | Tier-3 repeat fallback design |
