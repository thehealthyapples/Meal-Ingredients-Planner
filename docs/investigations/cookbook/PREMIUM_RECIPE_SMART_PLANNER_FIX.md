...
```
psql $DATABASE_URL -f docs/investigations/cookbook/PREMIUM_RECIPE_RESTORE_1558_1559.sql
```
...
| `docs/investigations/cookbook/PREMIUM_RECIPE_RESTORE_1558_1559.sql` | Full INSERT restore script for deleted rows 1558 and 1559 |
| `docs/investigations/cookbook/PREMIUM_RECIPE_SMART_PLANNER_AUDIT.md` | Audit investigation report |
...
`docs/investigations/cookbook/PREMIUM_RECIPE_RESTORE_1558_1559.sql`
...
Full implementation report: `docs/investigations/cookbook/PREMIUM_RECIPE_SMART_PLANNER_FIX.md`
Audit investigation report: `docs/investigations/cookbook/PREMIUM_RECIPE_SMART_PLANNER_AUDIT.md`
Restore SQL: `docs/investigations/cookbook/PREMIUM_RECIPE_RESTORE_1558_1559.sql`
...
Restore available: Yes — `docs/investigations/cookbook/PREMIUM_RECIPE_RESTORE_1558_1559.sql`
