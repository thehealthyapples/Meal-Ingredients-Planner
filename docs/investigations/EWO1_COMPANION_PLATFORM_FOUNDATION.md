...
| This task's writes | This file only: `docs/investigations/EWO1_COMPANION_PLATFORM_FOUNDATION.md` |
...
- Files modified by this task: `docs/investigations/EWO1_COMPANION_PLATFORM_FOUNDATION.md` (new file only)
- Rollback commands: `git checkout rollback/before-ewo1-companion-platform-foundation-20260703` (or, to only undo this file, `git rm docs/investigations/EWO1_COMPANION_PLATFORM_FOUNDATION.md`)
