...
| `docs/investigations/HOUSEHOLD_COMPATIBILITY_PHASE3_PLANNER_INTEGRATION.md` | Phase 3 — how `householdFit` was attached |
| `docs/investigations/HOUSEHOLD_COMPATIBILITY_PHASE4_HOUSEHOLD_FIT_DISPLAY.md` | Phase 4 — display confirmed, ranking confirmed unchanged |
| `docs/investigations/HOUSEHOLD_COMPATIBILITY_PHASE5_RESTRICTION_RESOLVER_INTEGRATION.md` | Phase 5 — resolver upgrade, ranking confirmed unchanged |
| `docs/investigations/HOUSEHOLD_COMPATIBILITY_V1_MASTER_PLAN.md` | Product goals, THA philosophy |
| `docs/investigations/HOUSEHOLD_COMPATIBILITY_V1_MASTER_PLAN_REVISION.md` | Architecture revision — profile-derived adults |
...
`docs/investigations/HOUSEHOLD_COMPATIBILITY_PHASE6_COMPATIBILITY_RANKING_PLAN.md`
