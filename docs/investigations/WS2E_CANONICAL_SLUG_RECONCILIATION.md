...
| **Undo this doc only** | `rm docs/investigations/WS2E_CANONICAL_SLUG_RECONCILIATION.md` |
...
**File location:** `docs/investigations/WS2E_CANONICAL_SLUG_RECONCILIATION.md`
