...
| This task's writes | `docs/ENGINEERING_WORKFLOW.md`, `docs/investigations/PROJECT_DOCUMENTATION_COMMIT_RULE.md` |
...
### `docs/investigations/PROJECT_DOCUMENTATION_COMMIT_RULE.md`
...
| Files modified | `docs/ENGINEERING_WORKFLOW.md`, `docs/investigations/PROJECT_DOCUMENTATION_COMMIT_RULE.md` |
| Rollback command | `git checkout rollback/before-project-documentation-commit-rule-20260630 -- docs/ENGINEERING_WORKFLOW.md && git rm docs/investigations/PROJECT_DOCUMENTATION_COMMIT_RULE.md` |
