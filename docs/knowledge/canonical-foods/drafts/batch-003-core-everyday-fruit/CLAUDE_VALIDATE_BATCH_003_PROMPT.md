Validate Canonical Food 003 without importing unsafe records.

Use the attached zip for `batch-003-core-everyday-fruit`.
...
4. Create report:
docs/investigations/BATCH_003_CANONICAL_FOOD_IMPORT_VALIDATION.md

Task:
- Extract the batch to docs/knowledge/canonical-foods/drafts/batch-003-core-everyday-fruit/
