Validate Canonical Food 006 without importing unsafe records.

Use the attached zip for `batch-006-legumes-beans-pulses-soy-foods`.
...
4. Create report:
docs/investigations/BATCH_006_CANONICAL_FOOD_IMPORT_VALIDATION.md

Task:
- Extract the batch to docs/knowledge/canonical-foods/drafts/batch-006-legumes-beans-pulses-soy-foods/
